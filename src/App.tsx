...
function AppContent() {
    ...
    const { getCourseProgressData, getLessonProgressData } = useProgress();
    ...
    const exerciseCounts = {}; // In a real reader build, this might be fetched or bundled. useProgress handles missing data gracefully.

    const courseProgress = getCourseProgressData(course.structure, exerciseCounts);
